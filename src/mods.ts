...
export type ShaheenEngine<Extensions extends object = object> = (
    ShaheenCore & Extensions
)
...
export type ZakhaarifMod<
    EngineExtensions extends object = object,
    ModExtensions extends object = object
> = (
    ZakhaarifModCore<EngineExtensions>
    & ModExtensions
)
